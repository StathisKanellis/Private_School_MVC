...
{
    public class TestTrainersController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "TrainerId,FirstName,LastName,DateOfBirth,Salary,PhotoUrl,Telephone,Email,Country")] Trainer trainer)
        {
