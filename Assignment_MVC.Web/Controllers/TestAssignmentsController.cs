...
namespace Assignment_MVC.Web.Controllers
{
    public class TestAssignmentsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "AssignmentId,Title,Description,SubTime")] Assignment assignment)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "AssignmentId,Title,Description,SubTime")] Assignment assignment)
        {
            if (ModelState.IsValid)
            {
